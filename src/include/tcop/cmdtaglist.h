...
PG_CMDTAG(CMDTAG_CREATE_ABAC_RULE, "CREATE ABAC RULE", false, false, false)
...
PG_CMDTAG(CMDTAG_CREATE_RESOURCE_ATTRIBUTE, "CREATE RESOURCE ATTRIBUTE", false, false, false)
...
PG_CMDTAG(CMDTAG_CREATE_USER_ATTRIBUTE, "CREATE USER ATTRIBUTE", false, false, false)
...
PG_CMDTAG(CMDTAG_DROP_ABAC_RULE, "DROP ABAC RULE", false, false, false)
...
PG_CMDTAG(CMDTAG_DROP_RESOURCE_ATTRIBUTE, "DROP RESOURCE ATTRIBUTE", false, false, false)
...
PG_CMDTAG(CMDTAG_DROP_USER_ATTRIBUTE, "DROP USER ATTRIBUTE", false, false, false)
...
PG_CMDTAG(CMDTAG_GRANT_ABAC_ADMIN, "GRANT ABAC ADMIN", false, false, false)
PG_CMDTAG(CMDTAG_GRANT_ROLE, "GRANT ROLE", false, false, false)
PG_CMDTAG(CMDTAG_GRANT_RESOURCE_ATTRIBUTE, "GRANT RESOURCE ATTRIBUTE", false, false, false)
PG_CMDTAG(CMDTAG_GRANT_USER_ATTRIBUTE, "GRANT USER ATTRIBUTE", false, false, false)
...
PG_CMDTAG(CMDTAG_REVOKE_ABAC_ADMIN, "REVOKE ABAC ADMIN", false, false, false)
PG_CMDTAG(CMDTAG_REVOKE_ROLE, "REVOKE ROLE", false, false, false)
PG_CMDTAG(CMDTAG_REVOKE_RESOURCE_ATTRIBUTE, "REVOKE RESOURCE ATTRIBUTE", false, false, false)
PG_CMDTAG(CMDTAG_REVOKE_USER_ATTRIBUTE, "REVOKE USER ATTRIBUTE", false, false, false)
...
PG_CMDTAG(CMDTAG_SET_ENV_ATTRIBUTE, "SET ENVIRONMENT ATTRIBUTE", false, false, false)
